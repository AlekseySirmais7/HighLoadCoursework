...
* БД для хранения пользователей с таргетингами: 13 16-ти ядерных сервера (RAM(GB) = 512; SSD(GB)=1024) + 13 шт на реплику.
...
+ 13шт на реплику. 13 Шардды по id_hash % кол-во шардов.
